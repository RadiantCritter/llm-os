...
def get_llm_os(
    ...
    return Assistant(
        ...
        introduction=dedent(
            """\
        Hi, I'm Ash - world's first LLM OS conceptualized by the og Andrej Karpathy himself.
        I have access to a set of tools and my very own AI Agents to assist you.
        Lets get started!\
        """
        ),
        debug_mode=debug_mode,
